...
/**
 * The interface Pid scheme loadable.
 */
@FunctionalInterface
public interface PidSchemeLoadable {

  /**
   * Trigger a loading of the PID scheme. Blocks until the PID scheme is loaded. This method can be called multiple times, but
   * only the first call will trigger an actual loading of the PID scheme.
   *
